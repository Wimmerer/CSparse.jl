...
function cs_dl_cholsol(order, A, b)
    @ccall libcxsparse.cs_dl_cholsol(order::Clonglong, A::Ptr{cs_dl}, b::Ptr{Cdouble})::Clonglong
end

function cs_dl_dupl(A)
    @ccall libcxsparse.cs_dl_dupl(A::Ptr{cs_dl})::Clonglong
end

function cs_dl_entry(T, i, j, x)
    @ccall libcxsparse.cs_dl_entry(T::Ptr{cs_dl}, i::Clonglong, j::Clonglong, x::Cdouble)::Clonglong
end

function cs_dl_lusol(order, A, b, tol)
    @ccall libcxsparse.cs_dl_lusol(order::Clonglong, A::Ptr{cs_dl}, b::Ptr{Cdouble}, tol::Cdouble)::Clonglong
end

function cs_dl_gaxpy(A, x, y)
    @ccall libcxsparse.cs_dl_gaxpy(A::Ptr{cs_dl}, x::Ptr{Cdouble}, y::Ptr{Cdouble})::Clonglong
end
...
function cs_dl_qrsol(order, A, b)
    @ccall libcxsparse.cs_dl_qrsol(order::Clonglong, A::Ptr{cs_dl}, b::Ptr{Cdouble})::Clonglong
end

function cs_dl_transpose(A, values)
    @ccall libcxsparse.cs_dl_transpose(A::Ptr{cs_dl}, values::Clonglong)::Ptr{cs_dl}
end
...
function cs_dl_print(A, brief)
    @ccall libcxsparse.cs_dl_print(A::Ptr{cs_dl}, brief::Clonglong)::Clonglong
end
...
function cs_dl_calloc(n, size)
    @ccall libcxsparse.cs_dl_calloc(n::Clonglong, size::Csize_t)::Ptr{Cvoid}
end
...
function cs_dl_realloc(p, n, size, ok)
    @ccall libcxsparse.cs_dl_realloc(p::Ptr{Cvoid}, n::Clonglong, size::Csize_t, ok::Ptr{Clonglong})::Ptr{Cvoid}
end

function cs_dl_spalloc(m, n, nzmax, values, t)
    @ccall libcxsparse.cs_dl_spalloc(m::Clonglong, n::Clonglong, nzmax::Clonglong, values::Clonglong, t::Clonglong)::Ptr{cs_dl}
end
...
function cs_dl_sprealloc(A, nzmax)
    @ccall libcxsparse.cs_dl_sprealloc(A::Ptr{cs_dl}, nzmax::Clonglong)::Clonglong
end

function cs_dl_malloc(n, size)
    @ccall libcxsparse.cs_dl_malloc(n::Clonglong, size::Csize_t)::Ptr{Cvoid}
end

mutable struct cs_dl_symbolic
    pinv::Ptr{Clonglong}
    q::Ptr{Clonglong}
    parent::Ptr{Clonglong}
    cp::Ptr{Clonglong}
    leftmost::Ptr{Clonglong}
    m2::Clonglong
    lnz::Cdouble
    unz::Cdouble
    cs_dl_symbolic() = new()
...
mutable struct cs_dl_dmperm_results
    ...
    s::Ptr{Clonglong}
    nb::Clonglong
    rr::NTuple{5, Clonglong}
    cc::NTuple{5, Clonglong}
...
function cs_dl_amd(order, A)
    @ccall libcxsparse.cs_dl_amd(order::Clonglong, A::Ptr{cs_dl})::Ptr{Clonglong}
end
...
function cs_dl_dmperm(A, seed)
    @ccall libcxsparse.cs_dl_dmperm(A::Ptr{cs_dl}, seed::Clonglong)::Ptr{cs_dld}
end

function cs_dl_droptol(A, tol)
    @ccall libcxsparse.cs_dl_droptol(A::Ptr{cs_dl}, tol::Cdouble)::Clonglong
end

function cs_dl_dropzeros(A)
    @ccall libcxsparse.cs_dl_dropzeros(A::Ptr{cs_dl})::Clonglong
end

function cs_dl_happly(V, i, beta, x)
    @ccall libcxsparse.cs_dl_happly(V::Ptr{cs_dl}, i::Clonglong, beta::Cdouble, x::Ptr{Cdouble})::Clonglong
end

function cs_dl_ipvec(p, b, x, n)
    @ccall libcxsparse.cs_dl_ipvec(p::Ptr{Clonglong}, b::Ptr{Cdouble}, x::Ptr{Cdouble}, n::Clonglong)::Clonglong
end

function cs_dl_lsolve(L, x)
    @ccall libcxsparse.cs_dl_lsolve(L::Ptr{cs_dl}, x::Ptr{Cdouble})::Clonglong
end

function cs_dl_ltsolve(L, x)
    @ccall libcxsparse.cs_dl_ltsolve(L::Ptr{cs_dl}, x::Ptr{Cdouble})::Clonglong
end
...
function cs_dl_permute(A, pinv, q, values)
    @ccall libcxsparse.cs_dl_permute(A::Ptr{cs_dl}, pinv::Ptr{Clonglong}, q::Ptr{Clonglong}, values::Clonglong)::Ptr{cs_dl}
end

function cs_dl_pinv(p, n)
    @ccall libcxsparse.cs_dl_pinv(p::Ptr{Clonglong}, n::Clonglong)::Ptr{Clonglong}
end

function cs_dl_pvec(p, b, x, n)
    @ccall libcxsparse.cs_dl_pvec(p::Ptr{Clonglong}, b::Ptr{Cdouble}, x::Ptr{Cdouble}, n::Clonglong)::Clonglong
end
...
function cs_dl_schol(order, A)
    @ccall libcxsparse.cs_dl_schol(order::Clonglong, A::Ptr{cs_dl})::Ptr{cs_dls}
end

function cs_dl_sqr(order, A, qr)
    @ccall libcxsparse.cs_dl_sqr(order::Clonglong, A::Ptr{cs_dl}, qr::Clonglong)::Ptr{cs_dls}
end

function cs_dl_symperm(A, pinv, values)
    @ccall libcxsparse.cs_dl_symperm(A::Ptr{cs_dl}, pinv::Ptr{Clonglong}, values::Clonglong)::Ptr{cs_dl}
end

function cs_dl_usolve(U, x)
    @ccall libcxsparse.cs_dl_usolve(U::Ptr{cs_dl}, x::Ptr{Cdouble})::Clonglong
end

function cs_dl_utsolve(U, x)
    @ccall libcxsparse.cs_dl_utsolve(U::Ptr{cs_dl}, x::Ptr{Cdouble})::Clonglong
end

function cs_dl_updown(L, sigma, C, parent)
    @ccall libcxsparse.cs_dl_updown(L::Ptr{cs_dl}, sigma::Clonglong, C::Ptr{cs_dl}, parent::Ptr{Clonglong})::Clonglong
end
...
function cs_dl_counts(A, parent, post, ata)
    @ccall libcxsparse.cs_dl_counts(A::Ptr{cs_dl}, parent::Ptr{Clonglong}, post::Ptr{Clonglong}, ata::Clonglong)::Ptr{Clonglong}
end

function cs_dl_cumsum(p, c, n)
    @ccall libcxsparse.cs_dl_cumsum(p::Ptr{Clonglong}, c::Ptr{Clonglong}, n::Clonglong)::Cdouble
end

function cs_dl_dfs(j, G, top, xi, pstack, pinv)
    @ccall libcxsparse.cs_dl_dfs(j::Clonglong, G::Ptr{cs_dl}, top::Clonglong, xi::Ptr{Clonglong}, pstack::Ptr{Clonglong}, pinv::Ptr{Clonglong})::Clonglong
end

function cs_dl_etree(A, ata)
    @ccall libcxsparse.cs_dl_etree(A::Ptr{cs_dl}, ata::Clonglong)::Ptr{Clonglong}
end

function cs_dl_fkeep(A, fkeep, other)
    @ccall libcxsparse.cs_dl_fkeep(A::Ptr{cs_dl}, fkeep::Ptr{Cvoid}, other::Ptr{Cvoid})::Clonglong
end

function cs_dl_house(x, beta, n)
    @ccall libcxsparse.cs_dl_house(x::Ptr{Cdouble}, beta::Ptr{Cdouble}, n::Clonglong)::Cdouble
end

function cs_dl_maxtrans(A, seed)
    @ccall libcxsparse.cs_dl_maxtrans(A::Ptr{cs_dl}, seed::Clonglong)::Ptr{Clonglong}
end

function cs_dl_post(parent, n)
    @ccall libcxsparse.cs_dl_post(parent::Ptr{Clonglong}, n::Clonglong)::Ptr{Clonglong}
end
...
function cs_dl_scatter(A, j, beta, w, x, mark, C, nz)
    @ccall libcxsparse.cs_dl_scatter(A::Ptr{cs_dl}, j::Clonglong, beta::Cdouble, w::Ptr{Clonglong}, x::Ptr{Cdouble}, mark::Clonglong, C::Ptr{cs_dl}, nz::Clonglong)::Clonglong
end

function cs_dl_tdfs(j, k, head, next, post, stack)
    @ccall libcxsparse.cs_dl_tdfs(j::Clonglong, k::Clonglong, head::Ptr{Clonglong}, next::Ptr{Clonglong}, post::Ptr{Clonglong}, stack::Ptr{Clonglong})::Clonglong
end

function cs_dl_leaf(i, j, first, maxfirst, prevleaf, ancestor, jleaf)
    @ccall libcxsparse.cs_dl_leaf(i::Clonglong, j::Clonglong, first::Ptr{Clonglong}, maxfirst::Ptr{Clonglong}, prevleaf::Ptr{Clonglong}, ancestor::Ptr{Clonglong}, jleaf::Ptr{Clonglong})::Clonglong
end

function cs_dl_reach(G, B, k, xi, pinv)
    @ccall libcxsparse.cs_dl_reach(G::Ptr{cs_dl}, B::Ptr{cs_dl}, k::Clonglong, xi::Ptr{Clonglong}, pinv::Ptr{Clonglong})::Clonglong
end

function cs_dl_spsolve(L, B, k, xi, x, pinv, lo)
    @ccall libcxsparse.cs_dl_spsolve(L::Ptr{cs_dl}, B::Ptr{cs_dl}, k::Clonglong, xi::Ptr{Clonglong}, x::Ptr{Cdouble}, pinv::Ptr{Clonglong}, lo::Clonglong)::Clonglong
end

function cs_dl_ereach(A, k, parent, s, w)
    @ccall libcxsparse.cs_dl_ereach(A::Ptr{cs_dl}, k::Clonglong, parent::Ptr{Clonglong}, s::Ptr{Clonglong}, w::Ptr{Clonglong})::Clonglong
end

function cs_dl_randperm(n, seed)
    @ccall libcxsparse.cs_dl_randperm(n::Clonglong, seed::Clonglong)::Ptr{Clonglong}
end

function cs_dl_dalloc(m, n)
    @ccall libcxsparse.cs_dl_dalloc(m::Clonglong, n::Clonglong)::Ptr{cs_dld}
end

function cs_dl_done(C, w, x, ok)
    @ccall libcxsparse.cs_dl_done(C::Ptr{cs_dl}, w::Ptr{Cvoid}, x::Ptr{Cvoid}, ok::Clonglong)::Ptr{cs_dl}
end

function cs_dl_idone(p, C, w, ok)
    @ccall libcxsparse.cs_dl_idone(p::Ptr{Clonglong}, C::Ptr{cs_dl}, w::Ptr{Cvoid}, ok::Clonglong)::Ptr{Clonglong}
end

function cs_dl_ndone(N, C, w, x, ok)
    @ccall libcxsparse.cs_dl_ndone(N::Ptr{cs_dln}, C::Ptr{cs_dl}, w::Ptr{Cvoid}, x::Ptr{Cvoid}, ok::Clonglong)::Ptr{cs_dln}
end

function cs_dl_ddone(D, C, w, ok)
    @ccall libcxsparse.cs_dl_ddone(D::Ptr{cs_dld}, C::Ptr{cs_dl}, w::Ptr{Cvoid}, ok::Clonglong)::Ptr{cs_dld}
end
...
function cs_cl_cholsol(order, A, b)
    @ccall libcxsparse.cs_cl_cholsol(order::Clonglong, A::Ptr{cs_cl}, b::Ptr{ComplexF32})::Clonglong
end

function cs_cl_dupl(A)
    @ccall libcxsparse.cs_cl_dupl(A::Ptr{cs_cl})::Clonglong
end

function cs_cl_entry(T, i, j, x)
    @ccall libcxsparse.cs_cl_entry(T::Ptr{cs_cl}, i::Clonglong, j::Clonglong, x::ComplexF32)::Clonglong
end

function cs_cl_lusol(order, A, b, tol)
    @ccall libcxsparse.cs_cl_lusol(order::Clonglong, A::Ptr{cs_cl}, b::Ptr{ComplexF32}, tol::Cdouble)::Clonglong
end

function cs_cl_gaxpy(A, x, y)
    @ccall libcxsparse.cs_cl_gaxpy(A::Ptr{cs_cl}, x::Ptr{ComplexF32}, y::Ptr{ComplexF32})::Clonglong
end
...
function cs_cl_qrsol(order, A, b)
    @ccall libcxsparse.cs_cl_qrsol(order::Clonglong, A::Ptr{cs_cl}, b::Ptr{ComplexF32})::Clonglong
end

function cs_cl_transpose(A, values)
    @ccall libcxsparse.cs_cl_transpose(A::Ptr{cs_cl}, values::Clonglong)::Ptr{cs_cl}
end
...
function cs_cl_print(A, brief)
    @ccall libcxsparse.cs_cl_print(A::Ptr{cs_cl}, brief::Clonglong)::Clonglong
end
...
function cs_cl_calloc(n, size)
    @ccall libcxsparse.cs_cl_calloc(n::Clonglong, size::Csize_t)::Ptr{Cvoid}
end
...
function cs_cl_realloc(p, n, size, ok)
    @ccall libcxsparse.cs_cl_realloc(p::Ptr{Cvoid}, n::Clonglong, size::Csize_t, ok::Ptr{Clonglong})::Ptr{Cvoid}
end

function cs_cl_spalloc(m, n, nzmax, values, t)
    @ccall libcxsparse.cs_cl_spalloc(m::Clonglong, n::Clonglong, nzmax::Clonglong, values::Clonglong, t::Clonglong)::Ptr{cs_cl}
end
...
function cs_cl_sprealloc(A, nzmax)
    @ccall libcxsparse.cs_cl_sprealloc(A::Ptr{cs_cl}, nzmax::Clonglong)::Clonglong
end

function cs_cl_malloc(n, size)
    @ccall libcxsparse.cs_cl_malloc(n::Clonglong, size::Csize_t)::Ptr{Cvoid}
end
...
function cs_cl_amd(order, A)
    @ccall libcxsparse.cs_cl_amd(order::Clonglong, A::Ptr{cs_cl})::Ptr{Clonglong}
end
...
function cs_cl_dmperm(A, seed)
    @ccall libcxsparse.cs_cl_dmperm(A::Ptr{cs_cl}, seed::Clonglong)::Ptr{cs_cld}
end

function cs_cl_droptol(A, tol)
    @ccall libcxsparse.cs_cl_droptol(A::Ptr{cs_cl}, tol::Cdouble)::Clonglong
end

function cs_cl_dropzeros(A)
    @ccall libcxsparse.cs_cl_dropzeros(A::Ptr{cs_cl})::Clonglong
end

function cs_cl_happly(V, i, beta, x)
    @ccall libcxsparse.cs_cl_happly(V::Ptr{cs_cl}, i::Clonglong, beta::Cdouble, x::Ptr{ComplexF32})::Clonglong
end

function cs_cl_ipvec(p, b, x, n)
    @ccall libcxsparse.cs_cl_ipvec(p::Ptr{Clonglong}, b::Ptr{ComplexF32}, x::Ptr{ComplexF32}, n::Clonglong)::Clonglong
end

function cs_cl_lsolve(L, x)
    @ccall libcxsparse.cs_cl_lsolve(L::Ptr{cs_cl}, x::Ptr{ComplexF32})::Clonglong
end

function cs_cl_ltsolve(L, x)
    @ccall libcxsparse.cs_cl_ltsolve(L::Ptr{cs_cl}, x::Ptr{ComplexF32})::Clonglong
end
...
function cs_cl_permute(A, pinv, q, values)
    @ccall libcxsparse.cs_cl_permute(A::Ptr{cs_cl}, pinv::Ptr{Clonglong}, q::Ptr{Clonglong}, values::Clonglong)::Ptr{cs_cl}
end

function cs_cl_pinv(p, n)
    @ccall libcxsparse.cs_cl_pinv(p::Ptr{Clonglong}, n::Clonglong)::Ptr{Clonglong}
end

function cs_cl_pvec(p, b, x, n)
    @ccall libcxsparse.cs_cl_pvec(p::Ptr{Clonglong}, b::Ptr{ComplexF32}, x::Ptr{ComplexF32}, n::Clonglong)::Clonglong
end
...
function cs_cl_schol(order, A)
    @ccall libcxsparse.cs_cl_schol(order::Clonglong, A::Ptr{cs_cl})::Ptr{cs_cls}
end

function cs_cl_sqr(order, A, qr)
    @ccall libcxsparse.cs_cl_sqr(order::Clonglong, A::Ptr{cs_cl}, qr::Clonglong)::Ptr{cs_cls}
end

function cs_cl_symperm(A, pinv, values)
    @ccall libcxsparse.cs_cl_symperm(A::Ptr{cs_cl}, pinv::Ptr{Clonglong}, values::Clonglong)::Ptr{cs_cl}
end

function cs_cl_usolve(U, x)
    @ccall libcxsparse.cs_cl_usolve(U::Ptr{cs_cl}, x::Ptr{ComplexF32})::Clonglong
end

function cs_cl_utsolve(U, x)
    @ccall libcxsparse.cs_cl_utsolve(U::Ptr{cs_cl}, x::Ptr{ComplexF32})::Clonglong
end

function cs_cl_updown(L, sigma, C, parent)
    @ccall libcxsparse.cs_cl_updown(L::Ptr{cs_cl}, sigma::Clonglong, C::Ptr{cs_cl}, parent::Ptr{Clonglong})::Clonglong
end
...
function cs_cl_counts(A, parent, post, ata)
    @ccall libcxsparse.cs_cl_counts(A::Ptr{cs_cl}, parent::Ptr{Clonglong}, post::Ptr{Clonglong}, ata::Clonglong)::Ptr{Clonglong}
end

function cs_cl_cumsum(p, c, n)
    @ccall libcxsparse.cs_cl_cumsum(p::Ptr{Clonglong}, c::Ptr{Clonglong}, n::Clonglong)::Cdouble
end

function cs_cl_dfs(j, G, top, xi, pstack, pinv)
    @ccall libcxsparse.cs_cl_dfs(j::Clonglong, G::Ptr{cs_cl}, top::Clonglong, xi::Ptr{Clonglong}, pstack::Ptr{Clonglong}, pinv::Ptr{Clonglong})::Clonglong
end

function cs_cl_etree(A, ata)
    @ccall libcxsparse.cs_cl_etree(A::Ptr{cs_cl}, ata::Clonglong)::Ptr{Clonglong}
end

function cs_cl_fkeep(A, fkeep, other)
    @ccall libcxsparse.cs_cl_fkeep(A::Ptr{cs_cl}, fkeep::Ptr{Cvoid}, other::Ptr{Cvoid})::Clonglong
end

function cs_cl_house(x, beta, n)
    @ccall libcxsparse.cs_cl_house(x::Ptr{ComplexF32}, beta::Ptr{Cdouble}, n::Clonglong)::ComplexF32
end

function cs_cl_maxtrans(A, seed)
    @ccall libcxsparse.cs_cl_maxtrans(A::Ptr{cs_cl}, seed::Clonglong)::Ptr{Clonglong}
end

function cs_cl_post(parent, n)
    @ccall libcxsparse.cs_cl_post(parent::Ptr{Clonglong}, n::Clonglong)::Ptr{Clonglong}
end
...
function cs_cl_scatter(A, j, beta, w, x, mark, C, nz)
    @ccall libcxsparse.cs_cl_scatter(A::Ptr{cs_cl}, j::Clonglong, beta::ComplexF32, w::Ptr{Clonglong}, x::Ptr{ComplexF32}, mark::Clonglong, C::Ptr{cs_cl}, nz::Clonglong)::Clonglong
end

function cs_cl_tdfs(j, k, head, next, post, stack)
    @ccall libcxsparse.cs_cl_tdfs(j::Clonglong, k::Clonglong, head::Ptr{Clonglong}, next::Ptr{Clonglong}, post::Ptr{Clonglong}, stack::Ptr{Clonglong})::Clonglong
end

function cs_cl_leaf(i, j, first, maxfirst, prevleaf, ancestor, jleaf)
    @ccall libcxsparse.cs_cl_leaf(i::Clonglong, j::Clonglong, first::Ptr{Clonglong}, maxfirst::Ptr{Clonglong}, prevleaf::Ptr{Clonglong}, ancestor::Ptr{Clonglong}, jleaf::Ptr{Clonglong})::Clonglong
end

function cs_cl_reach(G, B, k, xi, pinv)
    @ccall libcxsparse.cs_cl_reach(G::Ptr{cs_cl}, B::Ptr{cs_cl}, k::Clonglong, xi::Ptr{Clonglong}, pinv::Ptr{Clonglong})::Clonglong
end

function cs_cl_spsolve(L, B, k, xi, x, pinv, lo)
    @ccall libcxsparse.cs_cl_spsolve(L::Ptr{cs_cl}, B::Ptr{cs_cl}, k::Clonglong, xi::Ptr{Clonglong}, x::Ptr{ComplexF32}, pinv::Ptr{Clonglong}, lo::Clonglong)::Clonglong
end

function cs_cl_ereach(A, k, parent, s, w)
    @ccall libcxsparse.cs_cl_ereach(A::Ptr{cs_cl}, k::Clonglong, parent::Ptr{Clonglong}, s::Ptr{Clonglong}, w::Ptr{Clonglong})::Clonglong
end

function cs_cl_randperm(n, seed)
    @ccall libcxsparse.cs_cl_randperm(n::Clonglong, seed::Clonglong)::Ptr{Clonglong}
end

function cs_cl_dalloc(m, n)
    @ccall libcxsparse.cs_cl_dalloc(m::Clonglong, n::Clonglong)::Ptr{cs_cld}
end

function cs_cl_done(C, w, x, ok)
    @ccall libcxsparse.cs_cl_done(C::Ptr{cs_cl}, w::Ptr{Cvoid}, x::Ptr{Cvoid}, ok::Clonglong)::Ptr{cs_cl}
end

function cs_cl_idone(p, C, w, ok)
    @ccall libcxsparse.cs_cl_idone(p::Ptr{Clonglong}, C::Ptr{cs_cl}, w::Ptr{Cvoid}, ok::Clonglong)::Ptr{Clonglong}
end

function cs_cl_ndone(N, C, w, x, ok)
    @ccall libcxsparse.cs_cl_ndone(N::Ptr{cs_cln}, C::Ptr{cs_cl}, w::Ptr{Cvoid}, x::Ptr{Cvoid}, ok::Clonglong)::Ptr{cs_cln}
end

function cs_cl_ddone(D, C, w, ok)
    @ccall libcxsparse.cs_cl_ddone(D::Ptr{cs_cld}, C::Ptr{cs_cl}, w::Ptr{Cvoid}, ok::Clonglong)::Ptr{cs_cld}
end
...
function cs_l_real(A, real)
    @ccall libcxsparse.cs_l_real(A::Ptr{cs_cl}, real::Clonglong)::Ptr{cs_dl}
end

function cs_l_complex(A, real)
    @ccall libcxsparse.cs_l_complex(A::Ptr{cs_dl}, real::Clonglong)::Ptr{cs_cl}
end
